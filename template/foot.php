...
?>
    ...
    <script type="text/javascript" src="<?php echo str_repeat('../',$level) ?>plugins/datatables/jquery.dataTables.min.js"></script>
	<script type="text/javascript" src="<?php echo str_repeat('../',$level) ?>plugins/datatables/dataTables.bootstrap.min.js"></script>
    <script type="text/javascript" src="<?php echo str_repeat('../',$level) ?>plugins/datatables/extensions/RowReorder/js/dataTables.rowReorder.min.js"></script>
    <script type="text/javascript" src="<?php echo str_repeat('../',$level) ?>plugins/datatables/processing.js"></script>
    ...
    <script src="<?php echo str_repeat('../',$level) ?>dist/js/sweetalert.min.js"></script>
    <script src="<?php echo str_repeat('../',$level) ?>dist/js/sweetalert-dev.js"></script>    
    ...
    <script type="text/javascript">
        ...
        function submit(id){
            ...
            $("#comment_table").load("../marketing/ajax/submit_form.php?id="+id);
            $("#comment_table1").html("<span class='fa fa-refresh fa-pulse'></span>")
            $("#comment_table1").load("../inquiry/ajax/client_information.php?id="+id);
            $('#task_id').val(id);
        }
        function query(id){
