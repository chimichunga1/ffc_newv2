  ...
  <div class="box-body">
                <table id='dataTables' class="table responsive-table table-bordered table-striped" >
                    ...
                    <tbody>
                            ...
                            <td style="text-align:center;border: none transparent;background-color: #3c8dbc;color:white;">Cheque No.</td>
...
$queryv=$con->myQuery("SELECT c.`credit_amount`,CONCAT(cl.fname,' ',cl.lname) namee ,cl.client_number,c.cv_id FROM `cheque_dbcr` c INNER JOIN client_list cl ON cl.client_number=c.clnt_id WHERE NOT c.credit_amount='0' AND c.isDeleted='0' and `cv_no`='".$d."' ");
 ...
 <tr>
            ...
            <td>
               <center> <select class="form-control cbo validatee " data-placeholder="Bank Name" >
                                                  <?php echo makeOptions($bank) ?>
                                                  </select> </center>
            </td>
             <td>
                  <input class="form-control validatee numeric"  style="width: 100%;" type="text"  > 
            </td>
