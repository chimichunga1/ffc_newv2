                                   ...
                                   <div class='form-group row'>
                                        <label class='col-sm-12 col-md-1 control-label'> CV No: </label>
                                            <div class='col-sm-12 col-md-3'>
                                                <input type="text" readonly class="form-control" name="cv_no" placeholder="CV No." id='cv' >
                                            </div>
...
<script>
    ...
    function addcv() 
    {
        ...
        var cvx="<?php $maxcv=$con->myQuery('SELECT max(cv_id) from cheque_voucher')->fetch(PDO::FETCH_NUM); echo $maxcv[0]+100000; ?>";

        document.getElementById('cv').value = cvx;
        ...
        $.ajax({
            ...
            success: function(data) {
                    swal({
                    title: "Success!",
                    text: "Successfully Added CV No. " + cvx,
                    type: "success",
