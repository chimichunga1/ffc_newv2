...
$z=0;
     $slavequerycode="SELECT acc_no,cd,acc_code,debit_amount,credit_amount,clnt_id,jv_id  FROM journal_dbcr where jv_v_id='".$d."' ";
...
?>
 <div class="row">
                    ...
                    <div class="col-xs-12 col-md-3">
                         <button type="button" class="btn btn-primary btn-block" id="sumjv"  onclick="editjv()">Save</button>
                    </div>
