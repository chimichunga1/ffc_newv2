...
$query1=$con->myQuery("SELECT c.`cntrct_id`,c.`cd`,c.`acc_code`,c.`debit_amount`,c.`credit_amount`,c.`clnt_id`,CONCAT(cl.fname,' ',cl.lname ) fullname FROM `cheque_dbcr` c INNER JOIN client_list cl ON c.clnt_id=cl.client_number WHERE `cv_id`='".$d."' and isDeleted='0' ");
 ...
 <tr>
                                          ...
                                          <td>
                                            ...
                                            <td>
                                                   <input class="form-control debit numeric"  style="border: none transparent;width: 100%; text-align: center;" type="text" id="getallup" onkeyup="conditionedit();" value="<?php echo $row1[3]; ?>"> 
                                             </td>
                                            <td>
                                                 <input class="form-control credit numeric"  style="border: none transparent;width: 100%; text-align: center;" type="text" id="getallup"  onkeyup="conditionedit();" value="<?php echo $row1[4]; ?>"> 
                                             </td>
                                            <td>
