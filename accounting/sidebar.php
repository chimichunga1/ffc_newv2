          ...
          <ul class="treeview-menu menu-open">
             ...
             <!--    <span>General Ledger Entries</span> -->
                      <li class="treeview <?php echo $ledger; ?>">
                        ...
                        <ul class="treeview-menu menu-open">
                            <li class="<?php if($page1=='cv_gl_entries.php'){echo 'Active';} ?>"><a href="../accounting/cv_gl_entries.php">
                              <i class="fa fa-file-text"></i>
                              <span>Cheque Voucher</span>
                              </a>
                            </li>
                            <li class="<?php if($page1=='jv_gl_entries.php'){echo 'Active';} ?>"><a href="../accounting/jv_gl_entries.php">
                              <i class="fa fa-file-text"></i>
                              <span>Journal Voucher</span>
                              </a>
                            </li>
                               <li class="<?php if($page1=='cv_gl_validate.php'){echo 'Active';} ?>"><a href="../accounting/cv_gl_validate.php">
                              <i class="fa fa-file-text"></i>
                              <span>Cheque Voucher Validate</span>
                              </a>
                            </li>
                             </li>
                               <li class="<?php if($page1=='jv_gl_validate.php'){echo 'Active';} ?>"><a href="../accounting/jv_gl_validate.php">
                              <i class="fa fa-file-text"></i>
                              <span>Journal Voucher Validate</span>
                              </a>
                            </li>
                            <li class="<?php if($page1=='report_gl.php'){echo 'Active';} ?>"><a href="../accounting/report_gl.php">
                              <i class="fa fa-file-text"></i>
                              <span>Report</span>
                              </a>
                            </li>
          ...
          <ul class="treeview-menu menu-open">
             ...
             <!--    <span>General Ledger Entries</span> -->
                      <li class="treeview <?php echo $ledger; ?>">
                        <a href="#">
                          <i class="fa fa-file-text"></i> 
                          <span> Assigning / Printing of O.R. </span>
                        </a>
                        <ul class="treeview-menu menu-open">
                            <li class="<?php if($page1=='cv_gl_entries.php'){echo 'Active';} ?>"><a href="../accounting/or_c_awp.php">
                              <i class="fa fa-file-text"></i>
                              <span>Accounts w/ PDC</span>
                              </a>
                            </li>
                            <li class="<?php if($page1=='jv_gl_entries.php'){echo 'Active';} ?>"><a href="../accounting/or_c_csa.php">
                              <i class="fa fa-file-text"></i>
                              <span>Corporate S/A</span>
                              </a>
                            </li>
                               <li class="<?php if($page1=='cv_gl_validate.php'){echo 'Active';} ?>"><a href="../accounting/or_c_cp.php">
                              <i class="fa fa-file-text"></i>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-folder"></i> <span>Metadata</span></a>
              <ul class="treeview-menu menu-open">
                ...
                <li class="<?php if($page1=='Loan_type'){echo 'Active';} ?>"><a href="../administrator/requirement.php">
                  <i class="fa fa-circle-o"></i>
