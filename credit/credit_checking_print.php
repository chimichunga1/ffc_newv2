	...
	<div class="row col-md-12"><div>
                    ...
                    <table border="1" style='page-break-inside:auto !important;font-size:1vw;'>
                      <thead style='display:table-header-group !important;'>
                        ...
                        <th class='text-center' style='padding: 0.1cm;'>Loan Type</th>
                        <th class='text-center' style='padding: 0.1cm;'>Unit</th>
                        <th class='text-center' style='padding: 0.1cm;'>Amt. Fin.</th>
                        <th class='text-center' style='padding: 0.1cm;'>PN Amt.</th>
                        <th class='text-center' style='padding: 0.1cm;'>Terms</th>
                        <th class='text-center' style='padding: 0.1cm;'>Mon. Amor.</th>
                        <th class='text-center' style='padding: 0.1cm;'>Date Granted</th> 
                        <th class='text-center' style='padding: 0.1cm;'>Balance</th>
                        <th class='text-center' style='padding: 0.1cm;'>Security</th>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr class="text-center" style='page-break-inside:avoid !important; page-break-after:auto !important;'>
                            ...
                            <td style='padding: 0.1cm;'><?php $loan=$con->myQuery("SELECT name FROM loan_approval_type WHERE id=?",array($row['loan_type_id']))->fetch(PDO::FETCH_ASSOC);
                                echo $loan['name'];
                            ?></td>
                            <td style='padding: 0.1cm;'><?php echo htmlspecialchars($row['unit']) ?></td>
                            <td style='padding: 0.1cm;'><?php echo htmlspecialchars($row['amt_fin']) ?></td>
                            <td style='padding: 0.1cm;'><?php echo htmlspecialchars($row['pn_amount']) ?></td>
                            <td style='padding: 0.1cm;'><?php echo htmlspecialchars($row['terms']) ?></td>
                            <td style='padding: 0.1cm;'><?php echo htmlspecialchars($row['mon_amor']) ?></td>
                            <td style='padding: 0.1cm;'><?php echo htmlspecialchars($row['date_granted']) ?></td>
                            <td style='padding: 0.1cm;'><?php echo htmlspecialchars($row['balance']) ?></td>
                            <td style='padding: 0.1cm;'><?php echo htmlspecialchars($row['security']) ?></td>
