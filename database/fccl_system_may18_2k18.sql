...
--
-- Host: localhost
-- Generation Time: May 18, 2018 at 07:19 AM
...
CREATE TABLE `instruction_sheet_addon` (
  ...
  `list_cash_price` bigint(20) DEFAULT NULL,
  `addon_rate` bigint(20) DEFAULT NULL,
  `appraised_value` bigint(20) DEFAULT NULL,
  `mon_first_payment` bigint(20) DEFAULT NULL,
  `dp_gd_rv` bigint(20) DEFAULT NULL,
  `mon_second_payment` bigint(20) DEFAULT NULL,
  `start_date` date DEFAULT NULL,
  `maturity_date` date DEFAULT NULL,
  `due_date` date DEFAULT NULL,
  `value_date` date DEFAULT NULL,
  `amount_fin` bigint(20) DEFAULT NULL,
  `amount_pn` bigint(20) DEFAULT NULL,
  `rcf` bigint(20) DEFAULT NULL,
  `rebate_rcf` bigint(20) DEFAULT NULL,
  `TLV` bigint(20) DEFAULT NULL,
  `manner_payment` varchar(255) DEFAULT NULL,
  `less_udi_percent` bigint(20) DEFAULT NULL,
  `less_total` bigint(20) DEFAULT NULL,
  `udi_bal` bigint(20) DEFAULT NULL,
  `udi_first_mon` bigint(20) DEFAULT NULL,
  `udi_second_mon` bigint(20) DEFAULT NULL,
  `mort_fee` bigint(20) DEFAULT NULL,
  `sm_mort` varchar(255) DEFAULT NULL,
  `di_mort` varchar(255) DEFAULT NULL,
  `proc_fee` bigint(20) DEFAULT NULL,
  `sm_proc` varchar(255) DEFAULT NULL,
  `di_proc` varchar(255) DEFAULT NULL,
  `apprais_fee` bigint(20) DEFAULT NULL,
  `sm_apprais` varchar(255) DEFAULT NULL,
  `di_apprais` varchar(255) DEFAULT NULL,
  `comm_fee` bigint(20) DEFAULT NULL,
  `sm_comm` varchar(255) DEFAULT NULL,
  `di_comm` varchar(255) DEFAULT NULL,
  `front_fee` bigint(20) DEFAULT NULL,
  `sm_front` varchar(255) DEFAULT NULL,
  `di_front` varchar(255) DEFAULT NULL,
  `dealer_fee` bigint(20) DEFAULT NULL,
  `sm_fee` bigint(20) DEFAULT NULL,
  `real_estate_fee` bigint(20) DEFAULT NULL,
  `sm_real_estate` varchar(255) DEFAULT NULL,
  `di_real_estate` varchar(255) DEFAULT NULL,
  `insur_prem_fee` bigint(20) DEFAULT NULL,
  `sm_insur_prem` varchar(255) DEFAULT NULL,
  `di_insur_prem` varchar(255) DEFAULT NULL,
  `handling_fee` bigint(20) DEFAULT NULL,
  `sm_handling` varchar(255) DEFAULT NULL,
  `di_handling` varchar(255) DEFAULT NULL,
  `dpb_fee` bigint(20) DEFAULT NULL,
  `sm_dpb` varchar(255) DEFAULT NULL,
  `di_dpb` varchar(255) DEFAULT NULL,
  `doc_fee` bigint(20) DEFAULT NULL,
  `sm_doc` varchar(255) DEFAULT NULL,
  `di_doc` varchar(255) DEFAULT NULL,
  `sbgfc_fee` bigint(20) DEFAULT NULL,
  `sm_sbgfc` varchar(255) DEFAULT NULL,
  `di_sbgfc` varchar(255) DEFAULT NULL,
  `other_one_fee` bigint(20) DEFAULT NULL,
  `sm_other_one` varchar(255) DEFAULT NULL,
  `di_other_one` varchar(255) DEFAULT NULL,
  `other_two_fee` bigint(20) DEFAULT NULL,
  ...
  `or_amount` bigint(20) DEFAULT NULL,
  `payee1` varchar(255) DEFAULT NULL,
  `amount_payee1` bigint(20) DEFAULT NULL,
  `payee2` varchar(255) DEFAULT NULL,
  `amount_payee2` bigint(20) DEFAULT NULL,
  `payee3` varchar(255) DEFAULT NULL,
  `amount_payee3` bigint(20) DEFAULT NULL,
  `payee4` varchar(255) DEFAULT NULL,
  `amount_payee4` bigint(20) DEFAULT NULL,
  `payee5` varchar(255) DEFAULT NULL,
  `amount_payee5` bigint(20) DEFAULT NULL,
...
(25, '', '', '9', 'Alingalan', 'Carl Dennis', '', 1, 1, 2, 1, 2, 1, 2, '', '', 'majin_bu@gmail.com', '31214213123', '214123213', '312442131312', '412413123', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '2018-05-09', '2018-05-15', 0, 7, 0, NULL, 0),
...
(1, 'CJAY', 'D.', 'CONOCONO', 'TNTz0EXkSq4dC+kr8w8+UF14gOTFdx6RSEJpaGwQ7v4=', '1', 1, 1, 0, 1, 'LovAATjZX7extDhG7zbThmUxMuKZ4nvVLM/ucUpvnRE=', 0, '2018-05-18 00:39:01', 'admin', '1041518045921.png'),
