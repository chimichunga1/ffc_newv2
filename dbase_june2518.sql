...
insert  into `client_list`(`client_number`,`lname`,`fname`,`mname`,`ename`,`ind_corp_id`,`birthdate`,`gender`,`civil_status_id`,`spouse`,`tin_no`,`sss_no`,`acr_no`,`pagibig_no`,`rescert_no`,`rescert_date`,`rescert_place`,`bus_type_id`,`ind_code_id`,`client_type_id`,`country_id`,`region_id`,`con_name`,`con_rescert_no`,`con_rescert_date`,`con_rescert_place`,`home_no`,`home_brgy`,`home_city`,`home_zip`,`bus_no`,`bus_brgy`,`bus_city`,`bus_zip`,`gar_no`,`gar_brgy`,`gar_city`,`gar_zip`,`email`,`fax_no`,`bus_tel`,`home_tel`,`pri_con`,`sec_con`,`applied_by`,`applied_date`,`date_modified`,`same_add`,`same_add1`,`is_deleted`,`status_id`,`is_blacklisted`,`is_dealer`,`is_salesman`,`is_borrower`) values (1,'badion','test','0','0',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'test','','123','test','','','','',NULL,NULL,NULL,NULL,NULL,NULL,'','',NULL,NULL,'1','2018-06-25',NULL,'',NULL,0,0,0,NULL,NULL,NULL),(2,'badion','test','0','0',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'test','','123','test','','','','',NULL,NULL,NULL,NULL,NULL,NULL,'','',NULL,NULL,'1','2018-06-25',NULL,'',NULL,0,0,0,NULL,NULL,NULL),(3,'Togoto','Alexandrin','0','0',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'','','','','','','','',NULL,NULL,NULL,NULL,NULL,NULL,'','',NULL,NULL,'1','2018-06-25',NULL,'',NULL,0,0,0,NULL,NULL,NULL);
...
insert  into `client_requirements_cf`(`id`,`requirement_name`,`requirement_code`,`status`,`client_no`,`application_no`,`is_deleted`) values (1,'2x2 Picture ID','2X2','received',2,201806001,0),(2,'2 Valid ID','2VAL','received',2,201806001,0),(3,'Baranggay Clearance','BRCL','received',2,201806001,0),(4,'Tax Income','BIR','received',2,201806001,0);
...
insert  into `dealer`(`id`,`name`,`is_deleted`) values (1,'Dealer No. 1',0),(2,'NONE',1),(3,'DUMMY',0),(4,'Individual 1',1);
...
insert  into `industry_corp`(`id`,`name`,`is_deleted`) values (1,'Spark Global Tech Systems, Inc.',0),(2,'FCC',1),(3,'Individual',0);
...
CREATE TABLE `interview_sheet` (
  ...
  `bank_acct` varchar(255) DEFAULT NULL,
  `bank_date` varchar(255) DEFAULT NULL,
  `bank_ave` varchar(255) DEFAULT NULL,
  `loan_bank_name` varchar(255) DEFAULT NULL,
  `loan_bank_branch` varchar(255) DEFAULT NULL,
  `loan_bank_fac` varchar(255) DEFAULT NULL,
  `loan_bank_amt` varchar(255) DEFAULT NULL,
  `loan_bank_term` varchar(255) DEFAULT NULL,
  `loan_bank_date` varchar(255) DEFAULT NULL,
  `loan_bank_bal` varchar(255) DEFAULT NULL,
  `loan_ind_name` varchar(255) DEFAULT NULL,
  `loan_ind_con` varchar(255) DEFAULT NULL,
  `loan_ind_amt` varchar(255) DEFAULT NULL,
  `loan_ind_term` varchar(255) DEFAULT NULL,
  `loan_ind_date` varchar(255) DEFAULT NULL,
  `loan_ind_bal` varchar(255) DEFAULT NULL,
  `veh_brand` varchar(255) DEFAULT NULL,
  `veh_year` varchar(255) DEFAULT NULL,
  `veh_bank` varchar(255) DEFAULT NULL,
  `veh_amt` varchar(255) DEFAULT NULL,
  `veh_term` varchar(255) DEFAULT NULL,
  `real_loc` varchar(255) DEFAULT NULL,
  `real_sq` varchar(255) DEFAULT NULL,
  `real_year` varchar(255) DEFAULT NULL,
  `real_bank` varchar(255) DEFAULT NULL,
  `real_amt` varchar(255) DEFAULT NULL,
  `real_term` varchar(255) DEFAULT NULL,
  `dealer_id` bigint(20) DEFAULT NULL,
  `salesman_id` bigint(20) DEFAULT NULL,
  `purpose` varbinary(255) DEFAULT NULL,
  `date_applied` varchar(255) DEFAULT NULL,
  `applied_by` varchar(255) DEFAULT NULL,
  KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert  into `loan_list`(`id`,`app_type`,`app_no`,`client_no`,`last_name`,`first_name`,`spouse`,`dealer_id`,`salesman_id`,`loan_type_id`,`credit_fac_id`,`prod_line_id`,`mark_type_id`,`coll_code_id`,`bus_add`,`home_add`,`email_add`,`bus_tel`,`home_tel`,`pri_con`,`sec_con`,`unit_desc`,`amt_fin`,`res_val`,`down_pay`,`term`,`list_pri`,`int_rate`,`mon_amor`,`applied_by`,`ci_check_by`,`date_applied`,`date_modified`,`is_deleted`,`loan_status_id`,`is_approve`,`current_approver_id`,`approve_type`) values (1,'new','201806001','1','badion','test','',0,0,1,0,5,0,0,'','','','','','','','','','','','','','','',1,0,'2018-06-25',NULL,1,2,0,NULL,0),(2,'new','201806001','2','badion','test','',0,0,1,1,5,1,1,'','','','','','','','3213123','','','','','','','',1,0,'2018-06-25','2018-06-25',0,9,0,NULL,0),(3,'new','201806002','3','Togoto','Alexandrin','',0,0,1,1,5,1,1,'','','','','','','','13','','','','','','','',1,0,'2018-06-25','2018-06-25',0,6,0,NULL,0);
...
insert  into `neighbor_check`(`id`,`loan_id`,`client_no`,`tel_no`,`cel_no`,`leng_stay`,`acquire`,`free_name`,`free_rel`,`free_tel`,`rent_name`,`rent_pay`,`rent_tel`,`mort_name`,`mort_pay`,`mort_tel`,`prev_add`,`other_add`,`other_tel`,`desc_imp`,`equip_with`,`liv_con`,`liv_con_oth`,`neigh_spec`,`neigh_spec_oth`,`access_to`,`subj_rep`,`direction`,`date_applied`,`applied_by`) values (1,19,6,'1234','1234','12','owned','','','','','','','','','','','','','','','good',NULL,'subdivision',NULL,'bus','','','2018-05-28',0),(2,54,20,'123-4561','09497762178','Since Birth','free','Alexis T. Togoto','Parent','','','','','','','','','','','','','',NULL,'',NULL,'','','','06/25/2018',0);
...
insert  into `salesman`(`id`,`name`,`is_deleted`) values (1,'Salesman No. 1',0),(2,'Salesman 1',0),(3,'Salesman 2',0);
