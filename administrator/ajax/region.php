<?php
	...
	$columns = array(
        array( 'db' => 'country','dt' => ++$index,'formatter'=>function($d,$row)
		{
...
$complete_query="SELECT r.id,r.name,c.name as country FROM region r JOIN country c ON c.id=r.country_id {$where} {$order} {$limit}";    
