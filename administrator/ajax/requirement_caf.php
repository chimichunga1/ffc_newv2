...
<?php
	...
	$columns = array(
		array( 'db' => 'requirement_code','dt' => ++$index,'formatter'=>function($d,$row)
		{
	...
	require( '../../support/ssp.class.php' );
        ...
        $order="ORDER BY id";
		$filter_sql="";
        $whereAll="caf LIKE '%".$_GET['id']."%' AND is_deleted=0" ;
		$whereAll.=$filter_sql;
...
$complete_query="SELECT * FROM requirements {$where} {$order} {$limit}";    
