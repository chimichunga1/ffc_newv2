...
makeHead("Add Requirement (CAF)",1);
...
if (!empty($_GET['id'])) {
    ...
    $data=$con->myQuery("SELECT * FROM requirements WHERE caf NOT LIKE '%".$_GET['id']."%' AND is_deleted=0");
    $count =$con->myQuery("SELECT * FROM requirements WHERE caf NOT LIKE '%".$_GET['id']."%' AND is_deleted=0")->fetchColumn();
}
?>
...
<section class="content-header">
	...
	<div class="box-body">
	<center>
	<h3> Add Requirement - (CAF) </h3>
	</center>
	<hr>
			<div class="row">
                <form action="save_requirement_caf.php" method="post" class="form-horizontal" id='frmclear'>
                  <input type='hidden' name='id' id='id' value="<?php echo !empty($_GET['id'])?htmlspecialchars($_GET['id']):''?>">
                     ...
                     <label class="col-md-4 control-label">Requirements : </label>
                      <div class="col-md-5">
                        ...
                        <?php else :?>
                        <input type="text" class="form-control cbo" data-placeholder="Nothing to Select" disabled>
                        <?php endif;?>
                  ...
                  <div class="col-sm-11 col-md-offset-1 text-center">
                    ...
                    <a href='frm_requirement_caf.php?id=<?php echo $_GET['id']; ?>' class='btn btn-default'>Cancel</a><br>
                </div>
                </form>
            </div>		
            <br>
