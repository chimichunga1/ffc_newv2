...
<section class="content-header">
	...
	<div class="box">
		<div class="box-body">
				<a href='frm_add_cf_requirement.php?id=<?php echo $_GET['id'];?>'><button type="submit" class="btn btn-primary" id="btn-add" name="btnadd" style="float:right;"><i class="fa fa-plus"> Add Requirement </i></button></a>
		</div>
	<div class="box-body">
...
<script type="text/javascript">
	...
	function archive(id){
		...
		if (confirm("The requirement will be deleted. Are you sure?") == true) {
			...
			var string = href.substr(0,href.lastIndexOf('/'))+"/../php/delete.php?id=" + id +"&type=cfReq&loan_type_id="+<?php echo $_GET['id']; ?>;
    ...
    var dttable="";
      $(document).ready(function() {
        dttable=$('#dataTables').DataTable({
                ...
                "select":true,
                "ajax":{
                  "url":"ajax/requirement_cf.php?id=<?=$_GET['id'];?>"
