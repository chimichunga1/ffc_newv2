...
<section class="content-header">
	...
	<div class="box">
		<div class="box-body">
				<a href='frm_marketing_type.php'><button type="submit" class="btn btn-primary" id="btn-add" name="btnadd" style="float:right;"><i class="fa fa-plus"> Add New Marketing Type</i></button></a>
		</div>
	<div class="box-body">
...
<script type="text/javascript">
	...
	function edit(id){
		...
		//window.location ="/journal_entry.php?id=" + id;
		var href = window.location.href;
		var string = href.substr(0,href.lastIndexOf('/'))+"/frm_marketing_type.php?id=" + id;
		window.location=string;
	}
