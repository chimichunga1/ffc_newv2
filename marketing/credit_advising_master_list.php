...
makeHead("Credit Advising Master List",1);
...
<section class="content-header">
	...
	<div class="box-body">
	<center>
	<h2> Credit Advising Master List</h2>
	</center>
    <a href='credit_advising.php'>
        <button type='button' class="btn btn-default"><span class="fa fa-arrow-left"></span> Credit Advising </button></a><br><br>
	<hr><br>
			<div class="row">
...
<script type="text/javascript">
	...
	function edit(id){
		...
		//window.location ="/journal_entry.php?id=" + id;
		var href = window.location.href;
		var string = href.substr(0,href.lastIndexOf('/'))+"/credit_advising_form.php?id=" + id+"&ml";
		window.location=string;
	}
  ...
  var dttable="";
      $(document).ready(function() {
        dttable=$('#dataTables').DataTable({
                ...
                "select":true,
                "ajax":{
                  "url":"ajax/credit_advising_master_list.php"
