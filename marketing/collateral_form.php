...
<section class="content-header">
	...
	<hr><br>
            ...
            <div class="text-right" style="padding-right:20px;">
                <a href="collateral_master_list.php" class="btn btn-flat btn-success"> <span class="fa fa-book"></span> Master List</a>
            </div>
		</div>
	<div class="box-body">
  ...
  var dttable="";
      $(document).ready(function() {
        dttable=$('#dataTables').DataTable({
                ...
                "select":true,
                "ajax":{
                  "url":"ajax/collateral_entry_update.php"
