...
makeHead("Checklist Master List",1);
...
<section class="content-header">
	...
	<div class="box-body">
	<center>
	<h2> Checklist Master List </h2>
	</center>
    <a href="checklist_entry_update.php" class="btn btn-flat btn-default"> <span class="fa fa-arrow-left"></span> Checklist Entry/Update </a>
	<hr><br>
			<div class="row">
...
<script type="text/javascript">
	...
	function edit(id){
		...
		//window.location ="/journal_entry.php?id=" + id;
		var href = window.location.href;
		var string = href.substr(0,href.lastIndexOf('/'))+"/checklist_checking_form.php?id=" + id+"&ml";
		window.location=string;
	}
...
var dttable="";
      $(document).ready(function() {
        dttable=$('#dataTables').DataTable({
                ...
                "select":true,
                "ajax":{
                  "url":"ajax/checklist_master_list.php"
