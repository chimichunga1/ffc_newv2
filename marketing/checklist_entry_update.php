...
<section class="content-header">
	...
	<hr><br>
            ...
            <div class="text-right" style="padding-right:20px;">
                <a href="checklist_master_list.php" class="btn btn-flat btn-success"> <span class="fa fa-book"></span> Master List </a>
            </div>
		</div>
	<div class="box-body">
...
<script type="text/javascript">
	...
	function edit(id){
		...
		//window.location ="/journal_entry.php?id=" + id;
		var href = window.location.href;
		var string = href.substr(0,href.lastIndexOf('/'))+"/checklist_checking_form.php?id=" + id;
		window.location=string;
	}
...
var dttable="";
      $(document).ready(function() {
        dttable=$('#dataTables').DataTable({
                ...
                "select":true,
                "ajax":{
                  "url":"ajax/checklist_entry_update.php"
