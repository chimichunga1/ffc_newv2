...
makeHead("Instruction Sheet Prep.",1);
...
<section class="content-header">
	...
	<div class="box-body">
	<center>
	<h2> Instruction Sheet Preparation </h2>
	</center>
	<hr><br>
			<div class="row">
...
<script type="text/javascript">
	...
	function edit(id){
		...
		//window.location ="/journal_entry.php?id=" + id;
		var href = window.location.href;
		var string = href.substr(0,href.lastIndexOf('/'))+"/control_is.php?id=" + id;
		window.location=string;
	}
  ...
  var dttable="";
      $(document).ready(function() {
        dttable=$('#dataTables').DataTable({
                ...
                "select":true,
                "ajax":{
                  "url":"ajax/instruction_sheet_prep.php"
