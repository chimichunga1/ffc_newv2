	...
	$columns = array(
        ...
        'formatter' => function( $d, $row ) 
        {
			...
			if($row['loan_status_id']=='6'){
					...
					$action_buttons.="<input type='hidden' name='type' value='submit_credit_advising'>";
					$action_buttons.="<button type='submit' class='btn btn-success' data-toggle='tooltip' data-placement='left' name='action' title='Approve Request'><i class='fa fa-check'></i></button> ";
					$action_buttons.="</form>";
					...
					$action_buttons.="<input type='hidden' name='id' value={$row['id']}>";
					$action_buttons.="<input type='hidden' name='type' value='submit_credit_advising_redo'>";
